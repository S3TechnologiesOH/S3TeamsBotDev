 ...
 * @public
 */
declare class AutomateAPI extends Automate {
    /**
     * @public
     */
...
export type { AVTemplatePoliciesAPITypes, ClientsAPITypes, CommandsAPITypes, ComputersAPITypes, ContactsAPITypes, DataViewsAPITypes, DrivesAPITypes, EventLogsAPITypes, LocationsAPITypes, MaintenanceWindowDefinitionsAPITypes, MonitorsAPITypes, NetworkDevicesAPITypes, PatchingAPITypes, RemoteAgentAPITypes, ScriptingAPITypes, SearchesAPITypes, SystemAPITypes, TicketsAPITypes, UserProfilesAPITypes, };
//# sourceMappingURL=AutomateAPI.d.ts.map