...
export interface components {
    schemas: {
        ...
        'Automate.Api.Domain.Contracts.BatchContacts.WebClientAccessBatchRequest': {
            ...
            /** @enum {string} */
            EntityType?: 'System' | 'Computer' | 'Site' | 'Company' | 'Probe' | 'NetworkDevice' | 'Ticket' | 'Group' | 'MobileDevice' | 'Vendor' | 'VendorProduct' | 'Possibility' | 'Opportunity' | 'Contact' | 'User' | 'Script' | 'Plugin' | 'Service' | 'ServiceBundle' | 'Search' | 'SearchFolder' | 'Dataview' | 'DataviewFolder' | 'UserFolder' | 'UserClass';
            EntityIds?: number[];
        };
        ...
        'Automate.Api.Domain.Contracts.BatchCommands.SendTo.SendToCommandBatchRequest': {
            ...
            EntityIds?: number[];
            /** @enum {string} */
            TargetType?: 'System' | 'Computer' | 'Site' | 'Company' | 'Probe' | 'NetworkDevice' | 'Ticket' | 'Group' | 'MobileDevice' | 'Vendor' | 'VendorProduct' | 'Possibility' | 'Opportunity' | 'Contact' | 'User' | 'Script' | 'Plugin' | 'Service' | 'ServiceBundle' | 'Search' | 'SearchFolder' | 'Dataview' | 'DataviewFolder' | 'UserFolder' | 'UserClass';
            /** Format: int32 */
            TargetId?: number;
        };
...
//# sourceMappingURL=AutomateTypes.d.ts.map